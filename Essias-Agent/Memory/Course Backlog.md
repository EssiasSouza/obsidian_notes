...
This backlog uses the **PEM Matrix** (Personal, Business, Market) to prioritize courses.

## Prioritization Strategy
- **P0:** Immediate Execution (High urgency / High Business impact).
- **P1:** High Priority (Increases technical autonomy - Personal).
- **P2:** Medium-Low Priority (Market employability).
...
- **Duration:** 43 hours total.
- **PEM Score:** Personal (Low/Medium) | Business (High - 5/5) | Market (High).
- **Action:** Study by 2 weeks until finish it.
- **Place to learning**: Work or home
...
### [P3] Introduction to Blockchain (DIO)
- **Link:** [DIO Course](https://web.dio.me/course/visao-geral-sobre-blockchain/learning/40518060-be8f-4874-9cfe-1b84eeb2e187?autoplay=1)
- **Status:** Not started.
- **Duration:** 15 videos (approx. 4 hours).
- **PEM Score:** Personal (Medium) | Business (Low - 1/5) | Market (High - 4/5).
- **Action:** Keep on stand-by. Consume only during weekends or "free time", never competing with main focus hours.

---

## Triage Required (Needs PEM Score)

- 100 days of hands on
https://www.udemy.com/course/100-days-of-cloud-hands-on-labs/learn/lecture/55929149?start=0
- SysAdmin Linux - 100% Terminal - FREE
https://www.udemy.com/course/sysadmin-linux-free/learn/lecture/21654754?start=0#overview
- SAP S/4HANA BASIS Administrator — The Practical Admin Guide
https://www.udemy.com/course/future-proof-sap-basis-s4-hana-administrators-for-everyone/learn/lecture/52319375?start=0#overview
- EC - Emulate Adversarial Activity with Atomic Red Team
https://learn.eccouncil.org/course/emulate-adversarial-activity-with-atomic-red-team?logged=true
- EC - OWASP API Top 10 crAPI
https://learn.eccouncil.org/course/owasp-api-top-10-crapi?logged=true
- EC - Learn Burp Suite for Advanced Web Penetration Testing
https://learn.eccouncil.org/course/learn-burp-suite-for-advanced-web-penetration-testing
- EC - Red Team Mastery: Advanced Offensive Security
https://learn.eccouncil.org/course/red-team-mastery-advanced-offensive-security?logged=true
- Master the NEW TOEFL iBT 2026 Exam: A Complete Course
https://www.udemy.com/course/toefl-ibt-online-preparation-course/learn/lecture/52886047?start=0#overview
- DevOps BootCamp: Trilha de aprendizado rápido [All-in-one]
https://www.udemy.com/course/devops-bootcamp-trilha-de-aprendizado-rapido-all-in-one/learn/lecture/40642228?start=0#overview
- Appian Learning From Beginner to Advanced
https://www.udemy.com/course/appian-learning-from-beginner-to-advanced/learn/lecture/39888380?start=0#overview
- SAP Basis Complete Certification Training (beginner to guru)
https://www.udemy.com/course/sap-basis-certification-training/learn/lecture/24762604?start=15#overview
- ArgoCD: automatizando deploy de aplicações (dead-line 2026/07/01)
https://cursos.alura.com.br/course/argocd-automatizando-deploy-aplicacoes
- Mensageria com Java: RabbitMQ e Kafka (dead-line 2026/07/01)
https://cursos.alura.com.br/course/mensageria-java-rabbitmq-kafka
- Kubernetes com microsserviços: subindo e gerenciando uma aplicação (dead-line 2026/07/01)
https://cursos.alura.com.br/course/kubernetes-microsservicos-subindo-gerenciando-aplicacao
- DevOps: explorando conceitos, comandos e scripts no Linux CLI (dead-line 2026/07/01)
